...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    /* src\win\Titlebar.svelte generated by Svelte v3.46.4 */
    const file$3 = "src\\win\\Titlebar.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$3, 42, 20, 1776);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$3, 38, 20, 1413);
    			attr_dev(svg, "width", "13.5");
    			attr_dev(svg, "height", "13.5");
    			attr_dev(svg, "version", "1.1");
    			attr_dev(svg, "viewBox", "0 0 5.2917 5.2917");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file$3, 37, 16, 1282);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    			append_dev(svg, path);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 23, 4, 739);
    			...
    			add_location(rect1, file$3, 50, 16, 2450);
    ...
    /* src\nav\Login.svelte generated by Svelte v3.46.4 */
    const file$2 = "src\\nav\\Login.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "Join to the network!";
    			t3 = space();
    			button = element("button");
    			button.textContent = "Join";
    			attr_dev(h1, "class", "svelte-wr1nc5");
    			add_location(h1, file$2, 5, 4, 137);
    			attr_dev(p, "class", "svelte-wr1nc5");
    			add_location(p, file$2, 6, 4, 156);
    			attr_dev(button, "class", "join-button svelte-wr1nc5");
    			add_location(button, file$2, 7, 4, 189);
    			attr_dev(div, "class", "card svelte-wr1nc5");
    			add_location(div, file$2, 4, 0, 113);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\nav\Home.svelte generated by Svelte v3.46.4 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			h1.textContent = "Home";
    			attr_dev(h1, "class", "svelte-y90kd6");
    			add_location(h1, file$1, 3, 4, 55);
    			attr_dev(div, "class", "card svelte-y90kd6");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			create_component(router.$$.fragment);
    			attr_dev(div, "class", "background svelte-djus49");
    			add_location(div, file, 14, 1, 473);
    			attr_dev(main, "class", main_class_value = "" + (null_to_empty(/*isFocused*/ ctx[0] ? 'focused' : 'unfocused') + " svelte-djus49"));
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*isFocused*/ 1 && main_class_value !== (main_class_value = "" + (null_to_empty(/*isFocused*/ ctx[0] ? 'focused' : 'unfocused') + " svelte-djus49"))) {
